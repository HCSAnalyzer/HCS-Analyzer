...
namespace HCSAnalyzer.Simulator.Forms
{
    ...
    {
        public cCellPopulation CellPopulation;
        cPoint3D WorldDim;
        //cWorld CurrentWorld;
        ...
        public FormForInfoSingleCellPopInit_Simulator(cPoint3D WorldDim, cListVariables ListVariablesInput, FormForSimuGenerator Parent, cCellPopulation CellPopulation)
        {
            InitializeComponent();
        ...
        {
            CellPopulation = new cCellPopulation(this.textBoxName.Text);
            ...
            for (int i = 0; i < (int)numericUpDownInitialCellNumber.Value; i++)
            {
                ...
                cCell NewCell = new cCell(Parent.ListCellTypes.FindType(CellType), InitialPos, RND.NextDouble() /** ClassicCellCycle.ListProba.Count*/);
