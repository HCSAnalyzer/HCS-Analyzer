...
namespace HCSAnalyzer.Simulator.Forms.Panels
{
    public partial class PanelForParamCellPopulations : UserControl
    {
       ...
       FormForSimuGenerator Parent;
        ...
        {
            cCellPopulation SelectedCellPop = (cCellPopulation)listViewForCellPopulations.FocusedItem.Tag;
            ...
            if (WindowForSingleCellPop.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                cCellPopulation returnPop = WindowForSingleCellPop.CellPopulation;
        ...
        private void LoadItem(object sender, EventArgs e)
        {
            ...
            foreach (var FileName in CurrOpenFileDialog.FileNames)
            {
                ...
                Stream stream = new FileStream(FileName,
                                          ...
                                          FileAccess.Read,
                                          FileShare.Read);
                cCellPopulation obj = (cCellPopulation)formatter.Deserialize(stream);
                stream.Close();
        ...
        private void SaveItem(object sender, EventArgs e)
        {
            ...
            CurrSavefileDialog.FileName = ((cCellPopulation)listViewForCellPopulations.FocusedItem.Tag).Name + ".CP";
            ...
            formatter.Serialize(stream,  (cCellPopulation)listViewForCellPopulations.FocusedItem.Tag);
            stream.Close();
        }
