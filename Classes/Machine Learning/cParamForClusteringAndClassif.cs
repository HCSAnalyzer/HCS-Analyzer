...
using HCSAnalyzer.Classes.Machine_Learning.ClusteringInfo;
...
namespace HCSAnalyzer.Forms.FormsForOptions.ClassForOptions.Children
{
    ...
    public class cListClusteringAlgo : List<cParamAlgo>
    {
        public cListClusteringAlgo(List<string> ListDescritpors)
        {
            ...
            this.Add(new cParamManual("Manual", ListDescritpors));
        }
    ...
    [Serializable]
    public class cParamManual : cParamAlgo
    {
        public cParamManual(string Name, List<string> ListDescritpors)
            : base(Name)
        {
            PanelForParamManual PanelForOption = new PanelForParamManual(ListDescritpors);
            this.PanelToDisplay = PanelForOption.panel;
        }
    }
#endregion
