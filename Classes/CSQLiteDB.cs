...
namespace HCSAnalyzer.Classes
{
    public class cWellForDatabase
    {
        ...
        public List<List<double>> ListValues = new List<List<double>>();
        ...
        public void AddListSignatures(List<List<double>> ListValues)
        {
            this.ListValues.AddRange(ListValues);
        }

        public void AddSignature(List<double> Signature)
        {
    ...
    public class cSQLiteDatabase
    {
        ...
        {
            string WellName = TableToSave.TableName + "_" + PosX + "x" + PosY;
        ...
        {
            if (_SQLiteConnection != null) _SQLiteConnection.Close();

        }

        public void AddNewWell(cWellForDatabase WellForDatabase)
        {
            string WellName = "\"" + WellForDatabase.PlateName + "_" + WellForDatabase.PosX + "x" + WellForDatabase.PosY + "\"";
            string sql = "CREATE TABLE " + WellName + " ( rowid INTEGER PRIMARY KEY";
