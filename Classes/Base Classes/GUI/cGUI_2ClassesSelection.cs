...
namespace HCSAnalyzer.Classes.Base_Classes.GUI
{
    class cGUI_2ClassesSelection : cComponentGUI
    {
        ...
        public cFeedBackMessage Run(cGlobalInfo GlobalInfo)
        {
            ...
            PanelForClassSelection ClassSelectionPanel1 = new PanelForClassSelection(GlobalInfo, false, this.ClassType);
            ...
            PanelForClassSelection ClassSelectionPanel2 = new PanelForClassSelection(GlobalInfo, false, this.ClassType);
            ...
            ClassSelectionPanel2.Height = ClassSelectionPanel1.ListRadioButtons.Count * 25;
