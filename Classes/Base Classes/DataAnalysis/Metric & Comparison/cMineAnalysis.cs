...
namespace HCSAnalyzer.Classes.DataAnalysis
{
    public class cMineAnalysis : cDataAnalysisComponent
    {
        ...
        public List<cExtendedTable> GetOutPut()
        {
            return this.Output;
        }
        ...
        public void Run()
        {
            ...
            this.Output = new List<cExtendedTable>();
            ...
            for (int IdxTest = 2; IdxTest < ListNames.Length; IdxTest++)    // loop over all the different type of results
            {
                ...
                for (int i = 0; i < VarNames.Length; i++)
                {
                    ...
                    {
                        int IdxDesc = CurrentScreening.ListDescriptors.GetDescriptorIndex(NewTable[i].Name);
                        if (IdxDesc > -1)
                        {
                            NewTable[i].Tag = CurrentScreening.ListDescriptors[IdxDesc];
                        }
                    }
