      ...
      //  public int Opacity = 255;
       // public int MarkerSize = 10;
        ...
        public cChart1DStackedHistogram()
        {
            ...
            base.IsAllowDisplayTable = false;
        }
        ...
        void Refresh()
        {
            ...
            double GlobalMinX = this.input.Min();
            double GlobalMaxX = this.input.Max();

            for (int IdxSerie = 0; IdxSerie < input.Count; IdxSerie++)
            {
                if (input[IdxSerie].Count == 0) continue;
               ...
               // NewSerie.ChartType = SeriesChartType.Column;
                ...
                double Step = (GlobalMaxX - GlobalMinX) / CurrentHistogram[0].Count;
                ...
                for (int j = 0; j < CurrentHistogram[0].Count; j++)
                {
                   ...
                   // DP.XValue = Step * j + GlobalMinX;
                    ...
                    if (input[IdxSerie].Tag != null)
                    {
                        ...
                        if (input[IdxSerie].Tag.GetType() == typeof(cCellularPhenotype))
                        {
                            DP.Color = ((cCellularPhenotype)(input[IdxSerie].Tag)).ColourForDisplay;
                            DP.ToolTip = ((cCellularPhenotype)(input[IdxSerie].Tag)).Name + "\n";
                        }
        ...
        public void Run()
        {
            ...
            base.Run();
           // base.CurrentTitle.Text = "Stacked histogram(" + base.CurrentTitle.Text + ")";
        }
