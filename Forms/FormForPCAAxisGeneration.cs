...
namespace HCSAnalyzer.Forms
{
    public partial class FormForProjections : Form
    {
        ...
        public FormForProjections(cScreening CurrentScreening)
        {
            InitializeComponent();
        ...
        private void comboBoxForNeutralClass_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            SolidBrush BrushForColor = new SolidBrush(CurrentScreening.GlobalInfo.ListWellClasses[e.Index].ColourForDisplay);
