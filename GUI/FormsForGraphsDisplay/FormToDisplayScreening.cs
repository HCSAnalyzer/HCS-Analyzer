...
namespace HCSAnalyzer.Controls
{
    public abstract partial class cWindowToDisplayGeneralArray : Form
    {
        ...
        private void buttonOk_Click(object sender, EventArgs e)
        {
            ...
            PanelList[0].CurrentScreening.GlobalInfo.WindowHCSAnalyzer.toolStripcomboBoxPlateList.Items.Clear();
            ...
            for (int i = 0; i < PanelList.Count; i++)
            {
                PanelList[0].CurrentScreening.ListPlatesActive.Add(PanelList[0].CurrentScreening.ListPlatesAvailable.GetPlate(PanelList[i].AssociatedPlate.Name));
                PanelList[0].CurrentScreening.GlobalInfo.WindowHCSAnalyzer.toolStripcomboBoxPlateList.Items.Add(PanelList[0].CurrentScreening.ListPlatesActive[i].Name);
            }
            ...
            PanelList[0].CurrentScreening.GetCurrentDisplayPlate().DisplayDistribution(PanelList[0].CurrentScreening.ListDescriptors.CurrentSelectedDescriptorIdx, false);
    ...
    public class cWindowToDisplayEntireScreening : cWindowToDisplayGeneralArray
    {
        ...
        public cWindowToDisplayEntireScreening(List<cPanelForDisplayArray> PanelList, string Text, int XNumber, cGlobalInfo GlobalInfo)
        {
        ...
        {
            this.GlobalInfo.WindowHCSAnalyzer.PerformScreeningClustering(PlatesToCluster, false);
    ...
    public partial class FormToDisplayPlate : cPanelForDisplayArray
    {
        ...
        public FormToDisplayPlate(cPlate PlateToDisplay, cScreening CompleteScreening)
        {
            ...
            ValuesMatrix = PlateToDisplay.GetAverageValueDescTable1(CompleteScreening.ListDescriptors.CurrentSelectedDescriptorIdx, out ResMiss);
            System.Windows.Forms.ToolTip ToolTip = new System.Windows.Forms.ToolTip();
            ToolTip.SetToolTip(this, PlateToDisplay.Name + ". Replicate " + PlateToDisplay.ReplicateNumber);
        ...
        {
            for (int Idx = 0; Idx < CompleteScreening.GlobalInfo.WindowHCSAnalyzer.toolStripcomboBoxPlateList.Items.Count; Idx++)
            {
                if (CompleteScreening.GlobalInfo.WindowHCSAnalyzer.toolStripcomboBoxPlateList.Items[Idx].ToString() == this.AssociatedPlate.Name)
                {
                    CompleteScreening.GlobalInfo.WindowHCSAnalyzer.toolStripcomboBoxPlateList.SelectedIndex = Idx;
                    return;
                }
            }
